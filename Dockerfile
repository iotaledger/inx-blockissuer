...
# Build the binary
RUN go build -o /app/inx-blockissuer -a -ldflags="-w -s -X=github.com/iotaledger/inx-blockissuer/components/app.Version=${BUILD_VERSION}"
...
ENTRYPOINT ["/app/inx-blockissuer"]
